...
class MenuSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $menus = [
            // COFFEE MOCKTAIL
            ['name' => 'Dlima', 'description' => 'Espresso, Jus Delima dan Soda Lemon', 'price' => 28000, 'category_id' => $catCoffeeMocktail->id, 'image' => 'https://images.unsplash.com/photo-1514432324607-a09d9b4aefdd?q=80&w=600&auto=format&fit=crop'],
            ['name' => 'Sevam', 'description' => 'Espresso, Jus Apel dan Sirup Persik', 'price' => 28000, 'category_id' => $catCoffeeMocktail->id, 'image' => 'https://images.unsplash.com/photo-1534687241285-b1a7d6541f71?q=80&w=600&auto=format&fit=crop'],
            ['name' => 'Wilwa', 'description' => 'Espresso, Sirup Markisa dan Sirup Persik', 'price' => 28000, 'category_id' => $catCoffeeMocktail->id, 'image' => 'https://images.unsplash.com/photo-1572442388796-11668a67e53d?q=80&w=600&auto=format&fit=crop'],
            ['name' => 'Sindhu', 'description' => 'Espresso, Jus Jeruk, Peach Syrup', 'price' => 28000, 'category_id' => $catCoffeeMocktail->id, 'image' => 'https://images.unsplash.com/photo-1600262100650-717088b9a117?q=80&w=600&auto=format&fit=crop'],

            // CLASSIC ESPRESSO
            ['name' => 'Americano / Long Black', 'description' => 'Espresso dengan air mineral (Iced)', 'price' => 22000, 'category_id' => $catEspresso->id, 'image' => 'https://images.unsplash.com/photo-1514432324607-a09d9b4aefdd?q=80&w=600&auto=format&fit=crop'],
            ['name' => 'Cafe Latte / Cappuccino', 'description' => 'Espresso dengan susu steamed (Iced)', 'price' => 25000, 'category_id' => $catEspresso->id, 'image' => 'https://images.unsplash.com/photo-1534687241285-b1a7d6541f71?q=80&w=600&auto=format&fit=crop'],
            ['name' => 'Mochaccino', 'description' => 'Espresso, susu, dan coklat (Iced)', 'price' => 27000, 'category_id' => $catEspresso->id, 'image' => 'https://images.unsplash.com/photo-1572442388796-11668a67e53d?q=80&w=600&auto=format&fit=crop'],
            ['name' => 'AvoCoffee', 'description' => 'Espresso dengan perpaduan alpukat (Iced)', 'price' => 29000, 'category_id' => $catEspresso->id, 'image' => 'https://images.unsplash.com/photo-1600262100650-717088b9a117?q=80&w=600&auto=format&fit=crop'],
            ['name' => 'Caramel Macchiato', 'description' => 'Espresso, susu, vanila, dan saus karamel (Iced)', 'price' => 30000, 'category_id' => $catEspresso->id, 'image' => 'https://images.unsplash.com/photo-1485808191679-5f86510681a2?q=80&w=600&auto=format&fit=crop'],
            ['name' => 'Flavored Latte', 'description' => 'Pilihan rasa: Vanilla / Caramel / Hazelnut (Iced)', 'price' => 28000, 'category_id' => $catEspresso->id, 'image' => 'https://images.unsplash.com/photo-1551834289-408a2fcde524?q=80&w=600&auto=format&fit=crop'],
            ...
            // TEA
            ['name' => 'Mixed Fruit Tea', 'description' => 'Teh segar dengan campuran buah segar asli (Soda / Iced)', 'price' => 27000, 'category_id' => $catTea->id, 'image' => 'https://images.unsplash.com/photo-1513558161293-cdaf765ed2fd?q=80&w=600&auto=format&fit=crop'],
            ...
            ['name' => 'Lemon Tea', 'description' => 'Teh perasan lemon segar (Iced)', 'price' => 20000, 'category_id' => $catTea->id, 'image' => 'https://images.unsplash.com/photo-1556679343-c7306c1976bc?q=80&w=600&auto=format&fit=crop'],
            ['name' => 'Black Tea', 'description' => 'Classic premium black tea (Iced)', 'price' => 15000, 'category_id' => $catTea->id, 'image' => 'https://images.unsplash.com/photo-1576092762791-dd9e2220abd1?q=80&w=600&auto=format&fit=crop'],

            // NON COFFEE
            ['name' => 'Matcha Latte', 'description' => 'Premium Matcha dari Jepang (Iced)', 'price' => 27000, 'category_id' => $catNonCoffee->id, 'image' => 'https://images.unsplash.com/photo-1515823662972-da6a2e4d3002?q=80&w=600&auto=format&fit=crop'],
            ['name' => 'Chocolate Latte', 'description' => 'Susu coklat pekat yang lembut (Iced)', 'price' => 26000, 'category_id' => $catNonCoffee->id, 'image' => 'https://images.unsplash.com/photo-1542990253-0d0f5be5f0ed?q=80&w=600&auto=format&fit=crop'],
            ['name' => 'Red Velvet Latte', 'description' => 'Latte rasa Red Velvet yang creamy (Iced)', 'price' => 26000, 'category_id' => $catNonCoffee->id, 'image' => 'https://images.unsplash.com/photo-1611162458324-aae1eb4129a4?q=80&w=600&auto=format&fit=crop'],
            ['name' => 'Taro Latte', 'description' => 'Latte ungu manis khas rasa Taro (Iced)', 'price' => 25000, 'category_id' => $catNonCoffee->id, 'image' => 'https://images.unsplash.com/photo-1556881286-fc6915169721?q=80&w=600&auto=format&fit=crop'],
            ['name' => 'Avocado Latte', 'description' => 'Susu segar dengan campuran alpukat (Iced)', 'price' => 25000, 'category_id' => $catNonCoffee->id, 'image' => 'https://images.unsplash.com/photo-1600262100650-717088b9a117?q=80&w=600&auto=format&fit=crop'],
            ['name' => 'Hazelnut Chocolate Latte', 'description' => 'Coklat latte dengan aroma hazelnut premium (Iced)', 'price' => 28000, 'category_id' => $catNonCoffee->id, 'image' => 'https://images.unsplash.com/photo-1542990253-0d0f5be5f0ed?q=80&w=600&auto=format&fit=crop'],
            ...
            // SNACK
            ['name' => 'Donat Gula', 'description' => 'Donat empuk bertabur gula putih halus', 'price' => 7000, 'category_id' => $catSnack->id, 'image' => 'https://images.unsplash.com/photo-1551024506-0bccd828d307?q=80&w=600&auto=format&fit=crop'],
            ...
            ['name' => 'Siomay', 'description' => 'Siomay ikan hangat kukus dengan saus', 'price' => 25000, 'category_id' => $catSnack->id, 'image' => 'https://images.unsplash.com/photo-1625938144755-652e08e359b7?q=80&w=600&auto=format&fit=crop'],
        ...
        // Simple ingredient matching (Coffee Mocktail)
        $this->matchIngredients('Dlima', ['Biji Kopi Arabica']);
        $this->matchIngredients('Sevam', ['Biji Kopi Arabica']);
        $this->matchIngredients('Wilwa', ['Biji Kopi Arabica']);
        $this->matchIngredients('Sindhu', ['Biji Kopi Arabica']);

        // Classic Espresso
        $this->matchIngredients('Americano / Long Black', ['Biji Kopi Arabica']);
        $this->matchIngredients('Cafe Latte / Cappuccino', ['Biji Kopi Arabica', 'Susu Sapi']);
        $this->matchIngredients('Mochaccino', ['Biji Kopi Arabica', 'Susu Sapi', 'Coklat Bubuk']);
        $this->matchIngredients('AvoCoffee', ['Biji Kopi Arabica', 'Susu Sapi']);
        $this->matchIngredients('Caramel Macchiato', ['Biji Kopi Arabica', 'Susu Sapi', 'Sirup Karamel']);
        $this->matchIngredients('Flavored Latte', ['Biji Kopi Arabica', 'Susu Sapi']);
        $this->matchIngredients('Mont Blanc', ['Biji Kopi Arabica', 'Susu Sapi']);
        $this->matchIngredients('Butterscotch Latte', ['Biji Kopi Arabica', 'Susu Sapi']);
        $this->matchIngredients('Cloud Caramel Macchiato', ['Biji Kopi Arabica', 'Susu Sapi', 'Sirup Karamel']);

        // Tea
        $this->matchIngredients('Lychee Tea', ['Sirup Leci']);

        // Non Coffee
        $this->matchIngredients('Matcha Latte', ['Susu Sapi']);
        $this->matchIngredients('Chocolate Latte', ['Susu Sapi', 'Coklat Bubuk']);
        ...
        $this->matchIngredients('Hazelnut Chocolate Latte', ['Susu Sapi', 'Coklat Bubuk', 'Kacang Pohon']);
        $this->matchIngredients('Cloud Matcha', ['Susu Sapi']);

        // Roti Bakar
        $this->matchIngredients('Roti Bakar Cokelat', ['Gandum', 'Susu Sapi']);
        $this->matchIngredients('Roti Bakar Keju', ['Gandum', 'Susu Sapi', 'Keju Mozarella']);
        $this->matchIngredients('Roti Bakar Cokelat Keju', ['Gandum', 'Susu Sapi', 'Keju Mozarella']);
        
        // Snack
        $this->matchIngredients('Donat Gula', ['Gandum', 'Telur', 'Susu Sapi']);
        $this->matchIngredients('Siomay', ['Ikan', 'Kacang Tanah']);
        $this->matchIngredients('Cheesy Fries', ['Susu Sapi', 'Keju Mozarella']);
        
        // Mains
        $this->matchIngredients('Indomie Goreng Ebi', ['Gandum', 'Kerang/Seafood']);
        $this->matchIngredients('Spaghetti Bolognese', ['Gandum']);
        $this->matchIngredients('Cream Pasta', ['Gandum', 'Susu Sapi', 'Telur', 'Keju Mozarella']);
        $this->matchIngredients('Nasi Goreng Taraka', ['Telur']);
        $this->matchIngredients('Chicken Katsu Cheese', ['Gandum', 'Susu Sapi', 'Telur', 'Dada Ayam Fillet', 'Keju Mozarella']);
        $this->matchIngredients('Curry Rice Chicken Katsu', ['Gandum', 'Telur', 'Dada Ayam Fillet']);

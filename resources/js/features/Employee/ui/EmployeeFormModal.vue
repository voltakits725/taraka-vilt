...
<template>
    <div v-if="show" class="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4 overflow-y-auto">
        <div class="bg-surface rounded-2xl w-full max-w-2xl shadow-2xl overflow-hidden my-auto border border-border-theme">
            <div class="p-6">

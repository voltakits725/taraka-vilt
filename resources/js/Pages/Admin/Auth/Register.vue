...
<template>
    <div class="min-h-screen flex items-center justify-center bg-base text-text-main p-4 transition-colors duration-500">
        ...
        <div class="fixed inset-0 overflow-hidden pointer-events-none">
            <div class="absolute top-[10%] -left-[10%] w-[40%] h-[40%] rounded-full bg-accent/5 blur-[100px]"></div>
            <div class="absolute bottom-[10%] -right-[10%] w-[40%] h-[40%] rounded-full bg-accent/10 blur-[100px]"></div>
        </div>

        <div 
            class="w-full max-w-lg relative z-10 transition-all duration-700 ease-out py-8"
        ...
        >
            ...
            <div class="text-center mb-8">
                ...
                <h1 class="text-3xl font-extrabold tracking-tight">Registrasi Admin</h1>
                <p class="text-text-muted mt-2 text-sm font-medium">Buat akses pengelola baru untuk Cafe Taraka</p>
            </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <div class="relative group">
                                ...
                                <input 
                                    ...
                                    :class="{'border-red-500 focus:border-red-500 focus:ring-red-500/50': form.errors.name}"
                                >
                            </div>
                            <span v-if="form.errors.name" class="text-red-500 text-xs mt-1.5 ml-1 block font-medium">{{ form.errors.name }}</span>
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <div class="relative group">
                                ...
                                <input 
                                    ...
                                    class="w-full pl-12 pr-4 py-3.5 rounded-xl bg-base border border-border-theme text-text-main placeholder-text-muted focus:border-accent focus:ring-1 focus:ring-accent/50 outline-none transition-all text-sm font-medium"
                                    :class="{'border-red-500 focus:border-red-500 focus:ring-red-500/50': form.errors.email}"
                                >
                            </div>
                            <span v-if="form.errors.email" class="text-red-500 text-xs mt-1.5 ml-1 block font-medium">{{ form.errors.email }}</span>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative group">
                                ...
                                <input 
                                    ...
                                    :class="{'border-red-500 focus:border-red-500 focus:ring-red-500/50': form.errors.password}"
                                >
                                <button 
                                    type="button" 
                            ...
                            <span v-if="form.errors.password" class="text-red-500 text-xs mt-1.5 ml-1 block font-medium">{{ form.errors.password }}</span>
                        </div>

                        <!-- Confirm Password -->
                        <div>
                            <label class="block text-sm font-bold mb-2">Konfirmasi</label>
                            <div class="relative group">
                                <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-text-muted group-focus-within:text-accent transition-colors">
            ...
            <p class="text-center text-sm text-text-muted mt-8 font-medium">
                Sudah punya akun? 
                <Link href="/admin/login" class="text-accent hover:underline font-bold transition-colors">Login sekarang</Link>
            </p>
        </div>
    </div>
</template>